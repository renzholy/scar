...
export type GetBlocksQuery = { __typename?: 'Query', blocks: { __typename?: 'BlockConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean }, edges: Array<{ __typename?: 'BlockEdge', node: { __typename?: 'Block', id: string } }> } };


export const GetBlocksDocument = gql`
    query getBlocks {
  blocks(height: {max: 1000, min: 995}) {
    pageInfo {
      hasNextPage
    }
    edges {
